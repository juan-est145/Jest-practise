const { capitalize, reverse, calcObject, caesarCipher, analyzeArray } = require("./functions");
...
describe("Analyze array", () => {
	test("Analyze array empty", () => {
		expect(analyzeArray("Inválido")).toBe(null);
	});

	test("Analyze array invalid item", () => {
		expect(analyzeArray([4, -9, "ada"])).toBe(null);
	});

	test("Analyze array empty item", () => {
